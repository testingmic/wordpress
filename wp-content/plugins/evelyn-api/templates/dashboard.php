...
<div class="evelyn-wrapper">
	...
	// foreach($this->user_data['orders'] as $eachOrder) {
	// 	$productIds[] = $eachOrder['woocommerce'];
	// }
	// unset($this->user_data['orders'][4]);
	// update_option('evelynpos_api', $this->user_data);
	// $data = get_option('cron');
	// unset($data['1589586629']);
	// update_option('cron', $data);
							...
							<div class="modal-content">
								...
								<div class="modal-body">
									<p>
										...
										<hr>
										<strong>Last Import Date: </strong> <?= !empty($this->user_data['orders_last_sync']) ? $this->user_data['orders_last_sync'] : 'Unknown'; ?>
										<hr>
									</p>
									<p>
